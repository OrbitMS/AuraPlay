          ...
          <div className="flex flex-1 min-h-0 overflow-hidden">
            ...
            <div className="hidden sm:flex w-[200px] flex-shrink-0 bg-[var(--obsidian)] border-r border-[var(--bd)] flex-col py-5">
              ...
              <div className="px-2 mb-1">
                ...
                <div className="flex items-center gap-2.5 px-2.5 py-[7px] rounded-[5px] cursor-pointer text-[11px] tracking-[0.01em] border-l-2 border-[var(--gold)] bg-[rgba(201,168,76,0.08)] text-[var(--gold)]">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="w-[13px] h-[13px] flex-shrink-0"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
                  Search Music
                </div>
                <div className="flex items-center gap-2.5 px-2.5 py-[7px] rounded-[5px] cursor-pointer text-[11px] tracking-[0.01em] border-l-2 border-transparent text-[var(--tt)] hover:bg-white/[0.03] hover:text-[var(--ts)] transition-colors">
              ...
              <div className="px-2 mb-1">
                ...
                <div className="flex items-center gap-2.5 px-2.5 py-[7px] rounded-[5px] cursor-pointer text-[11px] tracking-[0.01em] border-l-2 border-transparent text-[var(--tt)] hover:bg-white/[0.03] hover:text-[var(--ts)] transition-colors">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="w-[13px] h-[13px] flex-shrink-0"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78L12 21.23l8.84-8.84a5.5 5.5 0 0 0 0-7.78z"/></svg>
                  Favorites
                </div>
              </div>
              ...
              <div className="mt-auto px-2 pt-3 border-t border-[var(--bd)]">
                <div className="flex items-center gap-2.5 px-2.5 py-[7px] rounded-[5px] cursor-pointer text-[11px] tracking-[0.01em] border-l-2 border-transparent text-[var(--tt)] hover:bg-white/[0.03] hover:text-[var(--ts)] transition-colors">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="w-[13px] h-[13px] flex-shrink-0"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14"/></svg>
                  Settings
                </div>
              </div>
            </div>
